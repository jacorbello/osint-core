...
_CAL_SYSTEM_MESSAGE = (
    ...
    "\n"
    "## RELEVANCE CLASSIFICATION (CRITICAL)\n"
    "You MUST accurately classify relevance. Most university policies are "
    "administrative and do NOT implicate constitutional rights.\n"
    "- 'relevant': directly involves a constitutional rights violation or "
    "restriction (e.g., speech code enforcement, religious expression ban, "
    "due process denial in disciplinary proceedings)\n"
    "- 'tangential': mentions constitutional topics but no clear violation "
    "(e.g., a general non-discrimination policy, a Title IX procedural update)\n"
    "- 'irrelevant': routine administrative, HR, financial, or operational "
    "policy with no constitutional rights dimension\n"
    "\n"
    "IRRELEVANT examples (return relevance='irrelevant', constitutional_basis=[]):\n"
    "- Compensation policies, executive pay, benefits\n"
    "- Veteran employment preferences, hiring procedures\n"
    "- Honorary titles and degrees, naming conventions\n"
    "- Budget, procurement, facilities management\n"
    "- IT security, data governance, records retention\n"
    "- Travel reimbursement, parking, campus operations\n"
    "\n"
    "For constitutional_basis, classify using one or more of these labels:\n"
    "1A-free-speech, 1A-religion, 1A-assembly, 1A-press, "
    "14A-due-process, 14A-equal-protection, parental-rights.\n"
    "Return an EMPTY list [] if the event is irrelevant or tangential.\n"
    "Only assign labels when there is a SPECIFIC constitutional rights issue.\n"
    "\n"
    "For lead_type, classify as 'incident' (a specific event involving individuals) "
    "or 'policy' (a rule, regulation, or institutional policy change that restricts "
    "constitutional rights). Return null for irrelevant events.\n"
    "\n"
