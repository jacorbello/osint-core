...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("severity_threshold", sa.Text(), server_default="medium", nullable=False),
        ...
        sa.Column("created_by", sa.Text(), server_default="manual", nullable=False),
...
def downgrade() -> None:
    op.drop_table("watch_events", schema="osint")
    op.drop_index("ix_watches_plan_id", table_name="watches", schema="osint")
    op.drop_index("ix_watches_status", table_name="watches", schema="osint")
    op.drop_table("watches", schema="osint")
